...
{
    int16_t result = Read16(ina219, INA219_REG_SHUNTVOLTAGE);
...
uint16_t INA219_ReadPower_raw(INA219_t *ina219)
{
...
{
    return (float)INA219_ReadPower_raw(ina219) * ina219_powerMultiplier_mW;
}
